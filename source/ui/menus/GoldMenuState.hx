...
An expanded upon version of the old MainMenuState.hx file.
Will be used for when the player selects "Play" on the actual main menu.
...
class GoldMenuState extends FlxState {
